...
namespace Laptopp.Controllers
{
    public class GioHangController : Controller
    {
        ...
        public ActionResult ThemGioHang(string ml, string url)
        {
            //Lấy giỏ hiện tại
        ...
        public ActionResult XoaSPKhoiGioHang(string gameID)
        {
            List<GioHang> lstgioHang = LayGioHang();
        ...
        public ActionResult CapNhatGioHang(string gameID, FormCollection f)
        {
            List<GioHang> lstGioHang = LayGioHang();
            GioHang sp = lstGioHang.SingleOrDefault(n => n.GameID == gameID);
        ...
        public ActionResult XoaMotSanPham(string gameID)
        {
